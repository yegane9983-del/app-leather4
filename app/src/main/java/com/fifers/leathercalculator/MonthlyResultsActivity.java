...
public class MonthlyResultsActivity extends Activity {
    ...
    private void refreshVisibleRecords() {
        ...
        visibleRecordsCountTextView.setText(toPersianDigits(String.valueOf(visibleRecords.size())) + " رکورد");
        applySummaryStatus(totalDifference, visibleRecords.size());
        recordsAdapter.notifyDataSetChanged();
        emptyTextView.setText("برای فیلتر انتخاب‌شده، سابقه‌ای ثبت نشده است.");
    ...
    private class RecordListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView metricsView = view.findViewById(R.id.recordMetricsTextView);
            ...
            metricsView.setText("تعداد: " + formatNumber(record.quantity)
